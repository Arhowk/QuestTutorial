...
CustomGameEventManager:Send_ServerToAllClients("quests_create_quest", {name = "Survive!", desc="The wolves are coming", max= 60, id= 5})
CustomGameEventManager:Send_ServerToAllClients("quests_update_quest", { max= 60,  current=0, id= 5})
